        ...
        <div class="modal-content">
            ...
            <form wire:submit="store">
                ...
                <div class="btn-group" role="group">
                    ...
                    <input type="radio" class="btn-check" name="btn-type" id="btn-type-dog" autocomplete="off"  checked>
                ...
                <div class="btn-group" role="group" >
                    <input type="radio" class="btn-check" name="btn-gender" id="btn-gender-f" autocomplete="off" checked>
